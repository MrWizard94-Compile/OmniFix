package org.omnifix.dynamiclanguages;
...
/**
 * Language map that stores pack Resource refs for values equal to file contents, reloading
 * via soft-value cache under memory pressure.
 */
public final class DynamicLanguageMap {

    private static final Logger LOGGER = LogUtils.getLogger();

    private DynamicLanguageMap() {}
                ...
                .build(new CacheLoader<>() {
                    ...
                    public Map<String, String> load(Resource resource) {
                        ...
                        try (var stream = resource.open()) {
                            ...
                            LOGGER.error("[OmniFix] Error loading language data from {}", resource.sourcePackId(), e);
                        }
                        return data;
                    }
                });
