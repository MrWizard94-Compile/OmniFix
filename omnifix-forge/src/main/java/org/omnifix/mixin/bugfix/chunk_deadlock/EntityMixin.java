...
/**
 * Skips the ENTITY_MOUNT game event when the passenger's chunk is not yet loaded, which otherwise
 * deadlocks sculk raytracing during worldgen entity load paths.
 */
@Mixin(Entity.class)
public class EntityMixin {
    ...
    @WrapWithCondition(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Lnet/minecraft/world/entity/Entity;gameEvent(Lnet/minecraft/world/level/gameevent/GameEvent;"
                            + "Lnet/minecraft/world/entity/Entity;)V"))
    private boolean omnifix$onlyAddIfSelfChunkLoaded(Entity instance, GameEvent event, Entity entity) {
        ...
        if (instance.level() instanceof ServerLevel serverLevel
            ...
            LOGGER.warn(
                    "Skipped emitting ENTITY_MOUNT game event for entity {} as it would cause deadlock",
                    instance.toString());
            return false;
        }
        return true;
