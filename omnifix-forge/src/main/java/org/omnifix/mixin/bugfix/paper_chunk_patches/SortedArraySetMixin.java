...
/**
 * Paper-style O(n) {@link #removeIf} for {@link SortedArraySet} (avoids iterator O(n²) and garbage).
 * Gated off when Moonrise is present via {@link org.omnifix.forge.mixin.OmniFixMixinPlugin}.
 */
