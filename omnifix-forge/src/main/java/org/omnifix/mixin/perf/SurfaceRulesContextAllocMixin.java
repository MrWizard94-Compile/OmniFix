...
import org.omnifix.worldgen.PositionalBiomeGetter;
...
/**
 * Reuse a single PositionalBiomeGetter instead of allocating a new supplier every updateY call.
 */
@Mixin(targets = "net.minecraft.world.level.levelgen.SurfaceRules$Context", priority = 100)
public abstract class SurfaceRulesContextAllocMixin {
    ...
    /**
     * @author OmniFix
     * @reason reuse biome supplier object
     */
    @Overwrite
