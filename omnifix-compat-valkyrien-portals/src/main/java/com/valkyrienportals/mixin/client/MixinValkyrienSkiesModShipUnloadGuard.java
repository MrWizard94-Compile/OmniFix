 ...
 * The selector pins both name and descriptor; with {@code defaultRequire: 1} a VS recompile that shifts
 * the lambda index fails loudly at load rather than silently mis-applying.
 */
